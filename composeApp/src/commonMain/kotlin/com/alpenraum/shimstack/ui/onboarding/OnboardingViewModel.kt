...
private fun generateTestSuspension(rand: Random) =
    Suspension(
        Pressure(rand.nextDouble(8.0, 20.0)),
        rand.nextDouble(0.2, 0.34),
        Damping(5, 5),
        Damping(7, null),
        rand.nextInt(0, 5),
        Distance(rand.nextDouble(80.0, 210.0))
    )

private fun generateTestTire(rand: Random) =
    Tire(
        Pressure(Random.nextDouble(1.0, 2.5)),
        Distance(Random.nextDouble(25.0, 50.0)),
        Distance(Random.nextDouble(0.0, 30.0))
    )